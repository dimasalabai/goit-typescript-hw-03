/*
	У цьому завданняi вам належить реалізувати сценарій життя, де людина, ключ і будинок взаємодіють один з одним.
...
class MyHouse extends House {
	openDoor(key: Key): void {
		if (key.getSignature() === this.key.getSignature()) {
			...
			console.log("Invalid key. Can't open the door.");
		}
	}
}
...
class Key {
	...
	constructor() {
		// Випадкове генерування signature
